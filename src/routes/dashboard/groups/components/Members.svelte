...
{#if memberList.showList}
	...
	>
		<div class="min-w-80 max-w-md">
			<div class="bg-[#3B234F] dark:bg-slate-900 px-4 py-5 rounded-t-lg">
			...
			<div>
				{#each group.members as member}
					<div
						class="bg-slate-400 dark:bg-slate-800 px-6 py-3 flex justify-between gap-1 items-center font-sans text-slate-700 dark:text-white border-b border-b-slate-600/30"
					>
			...
			<div class="flex justify-center bg-[#3B234F] dark:bg-slate-900 px-2 py-1.5 rounded-b-lg">
				<button
