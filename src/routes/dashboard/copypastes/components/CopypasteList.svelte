	...
	{#key copypastes}
		{#if !data.error && copypastes}
			...
			{#if copypastes.length === 0}
				<h2
					class="text-transparent text-balance bg-gradient-to-r from-violet-800 dark:from-blue-200 via-violet-400 dark:via-purple-300 to-purple-600 bg-clip-text text-xl md:text-2xl font-bold max-w-xl text-center mt-12"
				>
